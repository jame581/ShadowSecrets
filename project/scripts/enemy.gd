...
func _process(delta: float) -> void:
	...
	if chase_player and player != null:
		...
		# print("Player position: ", player.global_position, "Last player position: ", last_player_position)
		# if player.global_position.distance_to(last_player_position) > player_position_offset:
